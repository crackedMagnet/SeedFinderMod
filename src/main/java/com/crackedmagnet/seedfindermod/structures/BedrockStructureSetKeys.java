...
public class BedrockStructureSetKeys {
    public static final RegistryKey<StructureSet> BEDROCK_VILLAGES = RegistryKey.of(SeedFinderRegistries.BEDROCK_STRUCTURE_SETS_REGISTRY_KEY, new Identifier("seedfindermod:bedrock_villages"));
    public static final RegistryKey<StructureSet> BEDROCK_TEMPLES = RegistryKey.of(SeedFinderRegistries.BEDROCK_STRUCTURE_SETS_REGISTRY_KEY, new Identifier("seedfindermod:bedrock_temples"));
    public static final RegistryKey<StructureSet> BEDROCK_RUINED_PORTALS = RegistryKey.of(SeedFinderRegistries.BEDROCK_STRUCTURE_SETS_REGISTRY_KEY, new Identifier("seedfindermod:bedrock_ruined_portals"));
