...
public class BedrockRandom extends Random {
    ...
    public BedrockRandom(int seed, int chunkx, int chunkz) {
        valid=true;
        _setSeed(seed);
      
      int var5 = nextInt() | 1;
      int var7 = nextInt() | 1;
      int var9 = chunkx * var5 + chunkz * var7 ^ (int) seed;
      this.setSeed(var9);
    }
    ...
    public BedrockRandom(BedrockRandom toClone) {
        this.seed=toClone.seed;
        this.mt=new int[toClone.mt.length];
        System.arraycopy(toClone.mt, 0, mt, 0, toClone.mt.length);
        this.mti=toClone.mti;
        this.haveNextNextGaussian=toClone.haveNextNextGaussian;
        this.nextNextGaussian=toClone.nextNextGaussian;
        this.mtiFast=toClone.mtiFast;
        valid=true;
      ...
      int var5 = this.nextInt() | 1;
      int var7 = this.nextInt() | 1;
      
      int var9 = var3 * var5 + var4 * var7 ^ (int) var1;
      this.setSeed(var9);
      return var9;
   }
   
   public long setLargeFeatureWithSalt(long seed, int gridx, int gridz, int salt) {
      long featureSeed = (long)gridx * 341873128712L + (long)gridz * 132897987541L + seed + (long)salt;
      this.setSeed(featureSeed);
      return featureSeed;
   }
   
     public long setStrongholdSeed(long var1, int var3, int var4) {
      this.setSeed(var1);
      int var5 = this.nextInt() | 1;
      int var7 = this.nextInt() | 1;
      int var9 = (var3 * var5 + var4 * var7)*782756985 ^ (int) var1;
      this.setSeed(var9);
      return var9;
   }
    ...
    public long setLargeFeatureSeed(long worldseed, int chunkx, int chunkz) {
      ...
      long var5 = this.nextInt();
      long var7 = this.nextInt();
      long var9 = (long)chunkx * var5 ^ (long)chunkz * var7 ^ worldseed;
      this.setSeed(var9);
      return var9;
   }
   ...
   public int randomIntInclusive(int min, int max) {
    ...
    public void setSeed(long seed) {
        if(log) System.out.println("setSeed");
    ...
    @Override
    public int nextInt() {
        //if(log) System.out.println("nextInt()");
