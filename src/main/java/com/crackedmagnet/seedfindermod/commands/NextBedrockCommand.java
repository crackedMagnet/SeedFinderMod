...
import static com.crackedmagnet.seedfindermod.commands.LoadSeedCommand.LOGGER;
 ...
 */
public class NextBedrockCommand implements Command<ServerCommandSource> {

    //I really should combine the next commands somehow.
